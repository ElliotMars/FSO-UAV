...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5n_drone.yaml', help='model.yaml path')
...
if __name__ == '__main__':
    ...
    main(opt)
 # 检测摄像头
 # python detect.py  --weights runs/train/exp7/weights/best.pt --source 0  # webcam
 # 检测图片文件
